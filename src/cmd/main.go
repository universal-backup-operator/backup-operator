...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "51104944.backup-operator.io",
	...
	if err = (&controller.BackupStorageReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("BackupStorage"),
	...
	if err = (&controller.BackupScheduleReconciler{
		...
		Config:   mgr.GetConfig(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("BackupSchedule"),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&controller.BackupRunReconciler{
		...
		Config:   mgr.GetConfig(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("BackupRun"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BackupRun")
		os.Exit(1)
	}
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&backupoperatoriov1.BackupRun{}).SetupWebhookWithManager(mgr); err != nil {
